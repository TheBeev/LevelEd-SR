...
public class SCR_SpatialScriptBoolVariableOut : MonoBehaviour, ISSAcceptsBool, IOutputNode
{
    ...
    [SerializeField] NodeType nodeTypeRequired = NodeType.Bool;
