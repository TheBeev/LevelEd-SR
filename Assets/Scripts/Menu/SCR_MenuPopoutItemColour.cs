...
public class SCR_MenuPopoutItemColour : MonoBehaviour, IMenuPopoutItem, IToolMenuItem
{
    ...
    public void OnSelected()
    {
        ...
        parentPopoutMenu.PopoutSelected(toolToActivate, gameObject, colourToUse);
