...
public class SCR_MenuPopoutItemMaterial : MonoBehaviour, IMenuPopoutItem, IToolMenuItem
{
    ...
    [SerializeField] private bool bMaterialUsesColourValue;
    ...
    public void OnSelected()
    {
        ...
        parentPopoutMenu.PopoutSelected(toolToActivate, gameObject, materialToUse, bMaterialUsesColourValue);
